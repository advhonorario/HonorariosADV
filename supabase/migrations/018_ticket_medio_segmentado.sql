-- Adiciona dois indicadores de ticket médio segmentado (pedido do usuário
-- 2026-09-17): `ticket_medio_tipo_processo` (honorários ÷ nº de tipos de
-- processo distintos no período) e `ticket_medio_cliente` (honorários ÷ nº
-- de clientes distintos no período), ao lado do `ticket_medio` original
-- (honorários ÷ nº de lançamentos, agora rotulado "Ticket médio Advogados"
-- só no frontend — o cálculo em si não mudou).
