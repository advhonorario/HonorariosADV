-- Adiciona a Retenção do escritório (valor_base − repasse) ano a ano à série
-- `variacao_anual`, pedido do usuário 2026-09-17 depois de ver o gráfico
-- "Variação plurianual" só com honorários (escritório + advogados).
