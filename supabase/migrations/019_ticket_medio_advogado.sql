-- Adiciona `ticket_medio_advogado` (honorários ÷ nº de advogados distintos
-- envolvidos no rateio do período) — o "Ticket médio Advogados" pedido pelo
-- usuário 2026-09-17 é este, diferente do `ticket_medio` original (honorários
-- ÷ nº de lançamentos, agora rotulado "Ticket médio Lançamento" no frontend).
